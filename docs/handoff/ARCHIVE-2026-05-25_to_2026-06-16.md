# 2nd-Brain Handoff — Archive (2026-05-25 → 2026-06-16)

> 오래된 sprint 핸드오프 보관용. 최신 핸드오프 = [../HANDOFF.md](../HANDOFF.md).
> 2026-07-03 아카이브. ⚠️ 이 시점 이후 개념/디자인이 대폭 바뀜(별자리·북극성·rev2 Material-3) —
> 여기 내용은 **히스토리 참고용**이며 현재 정본이 아님. 정본은 docs/CONCEPT.md · docs/PRD.md · docs/REV2-MIGRATION.md.
