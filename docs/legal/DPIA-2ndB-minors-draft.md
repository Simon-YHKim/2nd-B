...
| **C-DEL** | Terminal account erasure (Art.17/PIPA) | `requestAccountDeletion()` `src/lib/records/delete-bulk.ts:315`; server identity binding `supabase/functions/delete-account/index.ts:182-220`; UI `src/screens/deepspace/DeepSpaceDesignScreens.tsx:671-678` | Code candidate; deployment requires migration `0186`, a forward Storage completion fence, and Edge deployment |
