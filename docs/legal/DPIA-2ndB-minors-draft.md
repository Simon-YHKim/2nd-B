...
| 8 | **Consent capture not wired at sign-up / no withdraw-consent flow** | GDPR Art.7 (demonstrable consent + Art.7(3) withdrawal); PIPA §22 | ⚠ **[RE-READ 2026-09-08]** immutable ledger built **and wired at sign-up** (`src/lib/supabase/consent.ts:132-134`); the remaining gap is the standing withdraw/re-consent UI | Eng + counsel (consent copy sign-off, D-03 external dependency) | **P1** |
