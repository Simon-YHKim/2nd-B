...
- **Why it does not yet satisfy Art.20:**
  - **Format:** Art.20 requires a "structured, commonly used and machine-readable format." The output is prose markdown built as an *LLM-context bundle / pre-delete backup* (`src/lib/wiki/export.ts:1-3, 21-22`), not a structured export. **[COUNSEL TO CONFIRM]** whether markdown qualifies.
