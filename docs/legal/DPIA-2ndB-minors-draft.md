...
4. **Sensitive data:** journaling = mental-health data; consent ledger captures `sensitive_data_ack`, `overseas_transfer_ack`, `llm_processing_ack` (`db/migrations/0031_consent_records.sql:26-28`) but the **notice/ack UI is "NOT YET WIRED"** (`db/migrations/0031_consent_records.sql:11-13`).
