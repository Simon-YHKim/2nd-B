    ...
    <ScreenPad>
      ...
      <div style={{ display: 'flex', gap: 12 }}>
        ...
        <div style={{ width: 128, height: 128, borderRadius: 22, flex: '0 0 auto', padding: 14, position: 'relative', overflow: 'hidden',
          ...
          <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 9, letterSpacing: '.12em', color: '#7FD0FF' }}>오늘의 별</div>
...
function AuthScreen({ t, go }) {
  ...
  return (
    <div style={{ height: '100%', overflowY: 'auto', display: 'flex', flexDirection: 'column',
      ...
      <div style={{ textAlign: 'center', padding: '0 30px 24px', fontSize: 11, color: 'rgba(190,225,255,.45)', wordBreak: 'keep-all' }}>
