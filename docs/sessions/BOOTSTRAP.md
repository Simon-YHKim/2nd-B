...
`v1` · 작성 2026-07-30 03:3x KST · 작성자 S7 콘솔 전담
...
1. `docs/sessions/PROTOCOL.md` — **세션 사이의 약속은 전부 거기에만 있다.**
2. `docs/handoff/fleet-handoff_260730.html` — 함대 상태 (2026-07-30 00:55 KST 실측)
3. `docs/sessions/R1/` 에서 **파일명에 자기 세션 ID가 들어간 파일 전부.** 특히 `-reply.md`.
