...
> **⚠ XPRIZE 는 2026-08-15 에 종료됐고 마감은 없다** (Simon 결정, 루트 `CLAUDE.md`).
> 아래 본문이 마감 `2026-08-17 06:00 KST` 와 출품 운영 목표를 **현재형으로** 적고
> 있는데 그 전제는 무효다. 승인 대상·근거 규율은 그대로 유효하지만, **마감이나
> 출품 목표를 근거로 스코프를 줄이지 말 것.** 기준은 실사용자다.
