...
//
//   was:  src/app/profile.tsx   (the EXPO_PUBLIC_UI=legacy renderer + its styles)
...
//           git show <sha-before-retirement>:src/app/profile.tsx
//
// ⚠ ProfileLegacy itself branched on isDeepSpaceUI() twice (:119, :338) even
// though the dispatcher above it already picked the deep-space screen. Those
// were dead branches inside a dead renderer; they are kept verbatim rather than
// tidied, because the point of this file is what the code WAS.
//
// The sign-in gate lives on the shipped screen (dds-profile-screen.tsx:87), and
// none of the 25 style keys were used above the dispatcher, so the route kept
// nothing.
//
