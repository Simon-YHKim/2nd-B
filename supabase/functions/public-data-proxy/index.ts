...
// already present in the app. Its quota contract is finalized in migration
// 0171; apply that migration before deploying this function.
  ...
  if (!parsedBody.ok && parsedBody.error !== "upstream_bad_payload") {
    return jsonResponse(
      req,
      {
        ...
        ...(parsedBody.providerCode ? { providerCode: parsedBody.providerCode } : {}),
      },
