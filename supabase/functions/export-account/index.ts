...
const EXCLUDED: Readonly<Record<string, string>> = Object.freeze({
  ...
  public_data_quota_daily: 'operational provider quota accounting',
  llm_proxy_capacity_reservations: 'operational capacity accounting',
  llm_proxy_purpose_daily: 'operational purpose quota accounting',
  reward_ssv_tickets: 'short-lived hashed ad callback binding',
  reward_ssv_issue_rate_limits: 'operational ad-ticket anti-abuse accounting',
  rewarded_ssv_txns: 'internal ad reward accounting',
  billing_self_service_rate_limits: 'operational billing anti-abuse accounting',
  oauth_naver_identities: 'hashed federated-identity security binding',
  peer_response_rate_limits: 'operational peer-response anti-abuse accounting',
  rss_proxy_quota_daily: 'operational RSS quota accounting',
  account_deletion_tombstones: 'security fence preventing deleted-account restoration',
