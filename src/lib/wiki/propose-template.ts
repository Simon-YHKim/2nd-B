  ...
  const system =
    locale === "ko"
      ? [
          ...
          "형식 이름은 담을 자료를 바로 알 수 있게 짓고, 설명은 쉬운 해요체로 쓰세요. 추상적인 비유·홍보 문구·상투적인 칭찬은 넣지 마세요. 자료에 없는 기능이나 효과를 약속하지 마세요.",
          "",
          "JSON 형식:",
          '{ "slug": "kebab-식별자",',
          '  "base_kind": 위 8개 중 하나,',
      ...
      : [
          ...
          "Name the kind of material directly. Write descriptions in plain, conversational language, using natural 해요체 in Korean. Avoid elaborate metaphors, promotional wording and stock praise. Do not promise features or effects the material does not support.",
          "",
          "JSON shape:",
