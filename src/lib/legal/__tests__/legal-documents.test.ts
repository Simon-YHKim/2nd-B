...
describe("legal document snapshots", () => {
  ...
  test("2026-09-25 policy keeps the required notice and prior technical disclosures", () => {
    ...
    expect(md).toContain("_시행일: 2026-09-25 · 최종 개정: 2026-09-25_");
    expect(PRIVACY_DOC.body).toContain("시행일: 2026-09-25");
