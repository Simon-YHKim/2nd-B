...
export const DEV_SCREEN_GROUPS: readonly DevScreenGroup[] = [
  {
    ...
    screens: [
      ...
      { file: "star/[domain]", href: "/star/career", label: "도메인 별 (커리어)", auth: true, sample: true, note: "career · finance · growth · relation · health · recreation · collect" },
  ...
  },
  {
    ...
    screens: [
      ...
      { file: "digest", href: "/digest", label: "주간 다이제스트", auth: true, note: "V6-D4: '오늘의 정리' 와 이름이 겹친다" },
