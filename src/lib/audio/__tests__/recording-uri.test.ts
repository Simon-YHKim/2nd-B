...
describe("recorder caller lifecycle contract", () => {
  ...
  test("cancel, recorder replacement, mode exit, and unmount use bounded cleanup", () => {
    ...
    expect(captureStartFlow).toContain("void stopAndDiscardRecording(audioRecorder)");
