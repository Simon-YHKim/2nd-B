...
export const ECR_ITEMS: readonly EcrItem[] = [
  ...
  { id: 1, dimension: "anxiety", reverse: false, en: "I worry about being abandoned.", ko: "나는 버림받을까 봐 걱정한다." },
  { id: 2, dimension: "anxiety", reverse: false, en: "I worry a lot about my close relationships.", ko: "나는 가까운 관계에 대해 자주 걱정한다." },
  { id: 3, dimension: "anxiety", reverse: false, en: "I worry that close others won't care about me as much as I care about them.", ko: "가까운 사람들이 내가 그들을 아끼는 만큼 나를 아끼지 않을까 봐 걱정된다." },
  { id: 4, dimension: "anxiety", reverse: false, en: "My desire to be very close sometimes scares people away.", ko: "가까워지고 싶은 내 욕구가 가끔 사람들을 밀어내는 것 같다." },
  { id: 5, dimension: "anxiety", reverse: false, en: "I need a lot of reassurance that I am loved by the people close to me.", ko: "가까운 사람들이 나를 사랑한다는 확인이 자주 필요하다." },
  { id: 6, dimension: "anxiety", reverse: false, en: "I find that close others don't want to get as close as I would like.", ko: "가까운 사람들이 내가 원하는 만큼 가까워지길 원하지 않는 것 같다." },
  // Avoidance subscale — 4 reverse-keyed + 2 positive-keyed.
  { id: 7, dimension: "avoidance", reverse: true, en: "It helps to turn to close others in times of need.", ko: "힘들 때 가까운 사람에게 의지하는 것이 도움이 된다." },
  { id: 8, dimension: "avoidance", reverse: true, en: "I usually discuss my problems and concerns with close others.", ko: "내 고민이나 걱정을 보통 가까운 사람과 나눈다." },
  { id: 9, dimension: "avoidance", reverse: true, en: "It's easy for me to be affectionate with close others.", ko: "가까운 사람에게 애정을 표현하는 것이 어렵지 않다." },
  { id: 10, dimension: "avoidance", reverse: true, en: "I feel comfortable depending on close others.", ko: "가까운 사람에게 기대는 것이 편안하다." },
  { id: 11, dimension: "avoidance", reverse: false, en: "I don't feel comfortable opening up to close others.", ko: "가까운 사람에게 마음을 여는 것이 편하지 않다." },
  { id: 12, dimension: "avoidance", reverse: false, en: "I prefer not to show close others how I feel deep down.", ko: "마음 깊은 곳의 감정을 가까운 사람에게도 잘 보이지 않는다." },
] as const;
