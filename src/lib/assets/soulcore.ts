...
export const V3_CORE_PNG: Record<string, number> = {
  core: require("../../../public/assets/soulcore/tier1_soul_core/soul_core_256.png"),
  relationship: require("../../../public/assets/soulcore/tier2_pattern_cores/bond_core_128.png"),
  knowledge: require("../../../public/assets/soulcore/tier2_pattern_cores/wisdom_core_128.png"),
  records: require("../../../public/assets/soulcore/tier2_pattern_cores/narrative_core_128.png"),
  inspiration: require("../../../public/assets/soulcore/tier2_pattern_cores/muse_core_128.png"),
  work_growth: require("../../../public/assets/soulcore/tier2_pattern_cores/growth_core_128.png"),
};
...
export const V3_DATA_PNG: Record<string, number> = {
  relation: require("../../../public/assets/soulcore/tier3_pattern_data/bond_pattern_data_96.png"),
  knowledge: require("../../../public/assets/soulcore/tier3_pattern_data/wisdom_pattern_data_96.png"),
  records: require("../../../public/assets/soulcore/tier3_pattern_data/narrative_pattern_data_96.png"),
  taste: require("../../../public/assets/soulcore/tier3_pattern_data/muse_pattern_data_96.png"),
  work: require("../../../public/assets/soulcore/tier3_pattern_data/growth_pattern_data_96.png"),
};
export const V3_DATA_PNG_DEFAULT = require("../../../public/assets/soulcore/tier3_pattern_data/narrative_pattern_data_96.png");

// Tier-4 Log PNG, keyed by domain (mapped to the nearest life-category log).
export const V3_LOG_PNG: Record<string, number> = {
  work: require("../../../public/assets/soulcore/tier4_logs/work_log_96x72.png"),
  knowledge: require("../../../public/assets/soulcore/tier4_logs/knowledge_log_96x72.png"),
  relation: require("../../../public/assets/soulcore/tier4_logs/relationship_log_96x72.png"),
  taste: require("../../../public/assets/soulcore/tier4_logs/hobby_log_96x72.png"),
};
export const V3_LOG_PNG_DEFAULT = require("../../../public/assets/soulcore/tier4_logs/knowledge_log_96x72.png");
...
export const V3_EDGE_PNG: Record<"current" | "near" | "mid" | "far", number> = {
  current: require("../../../public/assets/soulcore/pattern_links/pattern_link_current_320x64.png"),
  near: require("../../../public/assets/soulcore/pattern_links/pattern_link_near_320x64.png"),
  mid: require("../../../public/assets/soulcore/pattern_links/pattern_link_mid_320x64.png"),
  far: require("../../../public/assets/soulcore/pattern_links/pattern_link_far_320x64.png"),
};
