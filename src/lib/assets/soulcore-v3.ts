...
// see assets/legacy-art/cosmic-pixel-v3-soulcore/docs/asset_mapping.md.

import type { FC } from "react";
import type { SvgProps } from "react-native-svg";

import SoulCoreHero from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/soul_core_hero.svg";
import BondCore from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/bond_core.svg";
import WisdomCore from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/wisdom_core.svg";
import NarrativeCore from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/narrative_core.svg";
import MuseCore from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/muse_core.svg";
import GrowthCore from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/graph/growth_core.svg";
...
import PatternLinkFar from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/edges/pattern_link_far_320.svg";
import PatternLinkMid from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/edges/pattern_link_mid_320.svg";
import PatternLinkCurrent from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/edges/pattern_link_current_320.svg";
import PatternLinkNear from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/edges/pattern_link_near_320.svg";
import PatternConnectionPulse from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/overlays/pattern_connection_pulse.svg";
import SoulFocusGlow from "../../../assets/legacy-art/cosmic-pixel-v3-soulcore/mobile-graph/overlays/soul_focus_glow.svg";
...
export const V3_CORE_PNG: Record<string, number> = {
  ...
  relationship: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/bond_core_128.png"),
  knowledge: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/wisdom_core_128.png"),
  records: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/narrative_core_128.png"),
  inspiration: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/muse_core_128.png"),
  work_growth: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/growth_core_128.png"),
  // PLACEHOLDER (O-R3 G1): overwrite rhythm_core_128.png to apply the real asset.
  routine: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier2_pattern_cores/rhythm_core_128.png"),
};
...
export const V3_DATA_PNG: Record<string, number> = {
  relation: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/bond_pattern_data_96.png"),
  knowledge: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/wisdom_pattern_data_96.png"),
  records: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/narrative_pattern_data_96.png"),
  taste: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/muse_pattern_data_96.png"),
  work: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/growth_pattern_data_96.png"),
};
export const V3_DATA_PNG_DEFAULT = require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier3_pattern_data/narrative_pattern_data_96.png");
...
export const V3_LOG_PNG: Record<string, number> = {
  ...
  relation: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier4_logs/relationship_log_96x72.png"),
  taste: require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier4_logs/hobby_log_96x72.png"),
};
export const V3_LOG_PNG_DEFAULT = require("../../../assets/legacy-art/cosmic-pixel-v3-soulcore/final-candidate-v45/tier4_logs/knowledge_log_96x72.png");
