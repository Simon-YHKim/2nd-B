...
const CATS: Category[] = [
  {
    ...
    entries: [
      ...
      { date: "2017", ko: ["트랜스포머", "Attention Is All You Need, 오늘날 모든 LLM의 골격."], en: ["The Transformer", "Attention Is All You Need, the backbone of every modern LLM."] },
  ...
  },
  {
    ...
    entries: [
      { date: "2014", ko: ["GAN", "굿펠로우, 생성자와 판별자의 대결이 시작됐다."], en: ["GANs", "Goodfellow's generator versus discriminator duel."] },
      { date: "2015", ko: ["딥드림", "신경망이 꾸는 꿈을 처음 눈으로 봤다."], en: ["DeepDream", "The first look inside a network's dreams."] },
      { date: "2021", ko: ["DALL·E & CLIP", "글로 그림을 그리기 시작했다."], en: ["DALL·E & CLIP", "Drawing pictures straight from words."] },
      { date: "2022", ko: ["Diffusion 폭발", "Stable Diffusion·Midjourney가 이미지 생성을 모두의 손에."], en: ["Diffusion Boom", "Stable Diffusion and Midjourney put image-making in every hand."] },
  ...
  },
  {
    ...
    entries: [
      { date: "1997", ko: ["딥블루", "체스 세계 챔피언을 이긴 첫 기계."], en: ["Deep Blue", "The first machine to beat the chess world champion."] },
      { date: "2016", ko: ["AlphaGo", "이세돌을 꺾고 직관의 벽을 넘었다."], en: ["AlphaGo", "Defeated Lee Sedol, crossing the barrier of intuition."] },
      ...
      { date: "2024", ko: ["휴머노이드", "Figure·Optimus, 체화 지능이 떠오르다."], en: ["Humanoids", "Figure and Optimus, embodied intelligence rises."] },
    ],
  },
  {
    ...
    entries: [
      { date: "2011", ko: ["Siri & Watson", "말로 묻는 비서, 퀴즈쇼를 이긴 AI."], en: ["Siri & Watson", "A spoken assistant; an AI that won Jeopardy."] },
  ...
  },
  {
    ...
    entries: [
      { date: "2006", ko: ["CUDA", "GPU를 범용 계산기로 바꿨다."], en: ["CUDA", "Turned GPUs into general-purpose compute."] },
      { date: "2012", ko: ["GPU 딥러닝", "AlexNet이 GPU 위에서 우승했다."], en: ["GPU Deep Learning", "AlexNet won ImageNet running on GPUs."] },
      { date: "2016", ko: ["TPU", "구글의 AI 전용 칩."], en: ["TPU", "Google's purpose-built AI chip."] },
      { date: "2022", ko: ["H100", "생성형 AI를 떠받친 엔진."], en: ["H100", "The engine behind the generative AI wave."] },
      { date: "2024", ko: ["Blackwell", "조 단위 파라미터를 겨냥하다."], en: ["Blackwell", "Built for trillion-parameter models."] },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      ...
      { date: "2023", ko: ["EU AI Act & 안전 정상회의", "첫 포괄 규제와 국제 안전 논의."], en: ["EU AI Act & Safety Summit", "First broad regulation and global safety talks."] },
