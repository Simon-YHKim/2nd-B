...
const styles = StyleSheet.create({
  ...
  modeChip: { paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: colors.border, borderRadius: m3.shape.small, backgroundColor: colors.cardBg, color: colors.cyanSoft, fontSize: 12 },
  modeChipActive: { borderColor: colors.borderHi, backgroundColor: colors.mist, color: colors.textTitle },
  captureBox: { minHeight: 128, borderWidth: 1, borderColor: colors.border, borderRadius: m3.shape.none, backgroundColor: colors.cardBg, paddingHorizontal: 15, paddingVertical: 14, flexDirection: "row" },
  ...
  card: { paddingHorizontal: 16, paddingVertical: 15, borderWidth: 1, borderColor: colors.border, borderRadius: m3.shape.none, backgroundColor: colors.cardBg, marginBottom: 12 },
  ...
  emptyCard: { paddingHorizontal: 16, paddingVertical: 15, borderWidth: 1, borderStyle: "dashed", borderColor: colors.borderHi, borderRadius: m3.shape.none, backgroundColor: colors.cardBg },
  mutedBody: { color: colors.textLo, fontSize: 12.5 },
  reviewCard: { padding: 16, borderWidth: 1, borderColor: colors.soulLine, borderRadius: m3.shape.none, backgroundColor: colors.cardBg },
  ...
  scoreRow: { flexDirection: "row", alignItems: "center", gap: spacing.sm, paddingHorizontal: 13, paddingVertical: 11, borderRadius: m3.shape.none, backgroundColor: colors.bgMid },
  ...
  soulButton: { flex: 1.4, padding: 12, borderRadius: m3.shape.none, alignItems: "center", backgroundColor: colors.soul },
