...
const COPY: Record<AvailableUiLocale, HubCopy> = {
  en: {
    ...
    secondb: {
      ...
      sent: "Sent. This preview does not save the conversation.",
  ...
  ko: {
    ...
    secondb: {
      ...
      evidence: "내 기록 3건 근거",
      sent: "보냈어요. 이 미리보기에서는 대화가 저장되지 않습니다.",
  ...
  es: {
    ...
    secondb: {
      ...
      sent: "Enviado. Esta vista previa no guarda la conversación.",
  ...
  pt: {
    ...
    secondb: {
      ...
      sent: "Enviado. Esta prévia não salva a conversa.",
  ...
  id: {
    ...
    secondb: {
      ...
      sent: "Terkirim. Pratinjau ini tidak menyimpan percakapan.",
