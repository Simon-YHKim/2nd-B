...
const styles = StyleSheet.create({
  ...
  summaryNum: { fontFamily: m3.font.mono, fontSize: 24, fontWeight: "700" },
  ...
  pill: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 3, borderRadius: m3.shape.none, backgroundColor: m3.color.primaryContainer },
  ...
  deltaText: { fontFamily: m3.font.mono, fontSize: 12, color: m3.color.onSurfaceVariant },
