...
const THUMBS = {
  core_brain: require("../../../assets/legacy-art/2ndb-production-premium-v1/wiki/wiki_card_thumb_core_brain_premium.png"),
  library: require("../../../assets/legacy-art/2ndb-production-premium-v1/wiki/wiki_card_thumb_library_premium.png"),
  imagine: require("../../../assets/legacy-art/2ndb-production-premium-v1/wiki/wiki_card_thumb_imagine_premium.png"),
} as const;
