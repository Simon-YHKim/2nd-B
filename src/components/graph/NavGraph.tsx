...
const styles = StyleSheet.create({
  ...
  villageTagText: {
    ...
    // 11px 은 Galmuri 격자 밖이라 흐려진다(PRD §2-4). 12 가 Galmuri11 의 배수다.
    fontSize: 12,
    letterSpacing: 0,
    textAlign: "center",
  },
  ...
  sheetTitleRow: { flexDirection: "row", alignItems: "center", gap: 8, flex: 1, minWidth: 0 },
  sheetName: { flexShrink: 1, minWidth: 0 },
