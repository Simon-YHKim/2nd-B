...
const styles = StyleSheet.create({
  ...
  brandChipSub: { color: cosmic.mistGray, fontFamily: fontFamilies.sans, fontSize: 8, letterSpacing: 1 },
  ...
  btnIcon: { },
  btnLabel: { fontFamily: fontFamilies.sans, fontWeight: "700", fontSize: 14 },
  cta: { paddingVertical: spacing.lg, borderRadius: radii.xl },
  iconBtn: {
    width: 40,
    height: 40,
    borderRadius: radii.md,
