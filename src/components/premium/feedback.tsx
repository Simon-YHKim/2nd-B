...
const styles = StyleSheet.create({
  ...
  sheet: {
    ...
    backgroundColor: "rgba(13,21,48,0.97)",
    padding: spacing.lg,
    gap: spacing.sm,
    shadowColor: "#000",
    shadowOpacity: 0.5,
  ...
  sheetHandle: { alignSelf: "center", width: 38, height: 4, borderRadius: 2, backgroundColor: cosmic.lineDim, marginBottom: spacing.sm },
  ...
  modalCard: {
    ...
    borderWidth: 1,
    borderColor: cosmic.panelBorder,
    backgroundColor: "rgba(13,21,48,0.98)",
    padding: spacing.lg,
    gap: spacing.md,
  },
  toast: {
