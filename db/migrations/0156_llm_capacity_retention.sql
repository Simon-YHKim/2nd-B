-- 0156_llm_capacity_retention.sql
-- Bound the operational reservation ledger introduced by 0152.
--
...
-- table also stops growing. The 0152 fleet advisory lock is already held when
...
BEGIN
  ...
  ELSE
    RAISE NOTICE '0156: pg_cron unavailable; insert-trigger retention remains active';
  END IF;
END
$schedule$;
