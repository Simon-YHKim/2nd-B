...
BEGIN
  IF (
    ...
    RAISE EXCEPTION '0160 oauth naver constraint postcondition failed';
  END IF;
  ...
  FOREACH v_table IN ARRAY ARRAY[
    ...
    IF has_table_privilege(
      ...
      RAISE EXCEPTION '0160 oauth naver table postcondition failed: %', v_table;
    END IF;
  END LOOP;
  ...
  FOREACH v_function IN ARRAY ARRAY[
    ...
    IF has_function_privilege('anon', v_function, 'EXECUTE')
      ...
      RAISE EXCEPTION '0160 oauth naver function postcondition failed: %', v_function;
    END IF;
  END LOOP;
END
$postconditions$;
