-- 0182_peer_response_atomicity.sql
...
-- Close any pre-0182 rows left active beneath an already-withdrawn invitation.
...
BEGIN
  IF has_function_privilege(
    ...
    RAISE EXCEPTION '0182 peer response atomicity postcondition failed';
  END IF;
END
$postconditions$;
