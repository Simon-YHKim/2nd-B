  ...
  return (
    <MdCard variant="outlined" style={{ padding: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
        <span style={{ width: 26, height: 26, flex: '0 0 auto', borderRadius: 0, background: C('secondary-container'), color: C('on-secondary-container'),
          display: 'grid', placeItems: 'center', fontWeight: 700, fontSize: 12 }}>{idx + 1}</span>
        <input value={it.name} onChange={(ev) => set('name', ev.target.value)} placeholder="활동 이름 (예: 클라이밍)" aria-label="활동 이름"
          style={{ flex: 1, minWidth: 0, border: 'none', borderBottom: `2px solid ${C('outline-variant')}`, background: 'transparent',
            color: C('on-surface'), fontSize: 15, fontWeight: 700, padding: '6px 2px', outline: 'none', fontFamily: 'var(--md-ref-typeface-plain)' }} />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 12, fontWeight: 700, color: C('on-primary-container'), background: C('primary-container'), borderRadius: 0, padding: '2px 8px' }}>★ 가장 중요</span>
          </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ flex: 1, overflowY: 'auto', padding: '4px 16px 14px' }}>
        ...
        <MdCard variant="filled" style={{ padding: 0, marginBottom: 14, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '0 16px 14px', display: 'flex', flexDirection: 'column', gap: 9 }}>
              ...
              <div key={h} style={{ display: 'flex', gap: 8 }}>
                  <span style={{ width: 5, height: 5, borderRadius: 0, background: C('tertiary'), flex: '0 0 auto', marginTop: 7 }} />
        ...
        {items.length === 0 &&
        <div style={{ border: `2px dashed ${C('outline-variant')}`, borderRadius: 0, padding: '30px 20px', textAlign: 'center' }}>
