/* ============================================================
   ...
   Export: window.MuseumScreen, window.MUSEUM
   ============================================================ */
...
const MZ_LANES = {
  world: { id: 'world', label: 'AI와 세계의 흐름', en: 'WORLD', icon: 'public',
    accent: 'var(--accent)', tint: 'rgba(91,157,255,.16)', ink: 'var(--c07)' },
  ai: { id: 'ai', label: 'AI 발전사', en: 'AI', icon: 'auto_awesome',
    accent: 'var(--ds-nebula)', tint: 'rgba(154,134,255,.16)', ink: 'var(--ds-nebula-soft)' }
};
...
/* ---- 전시 도판 — 위키미디어 공용(퍼블릭 도메인 · CC) 사진. 표기는 아래 credit. ---- */
const MZ_PHOTO = {
  w_ww2: ['https://commons.wikimedia.org/wiki/Special:FilePath/Colossus-rebuild.jpg?width=640', '콜로서스 재현기 · Bletchley Park (CC BY-SA 3.0)'],
  w_sputnik: ['https://commons.wikimedia.org/wiki/Special:FilePath/Replica%20of%20Sputnik%201%2C%20World%20Museum%20Liverpool%20(1).JPG?width=640', '스푸트니크 1호 복제품 (CC BY-SA 3.0)'],
  w_moon: ['https://commons.wikimedia.org/wiki/Special:FilePath/Apollo%2011%20Launch%20-%20GPN-2000-000630.jpg?width=640', '아폴로 11호 발사 · NASA (Public domain)'],
  w_intel: ['https://commons.wikimedia.org/wiki/Special:FilePath/Intel%204004%20open%202.jpg?width=640', '인텔 4004 다이 (CC BY 4.0)'],
  w_www: ['https://commons.wikimedia.org/wiki/Special:FilePath/First%20Web%20Server.jpg?width=640', '최초의 웹 서버 · CERN (CC BY-SA 3.0)'],
  w_dotcom: ['https://commons.wikimedia.org/wiki/Special:FilePath/Nasdaq%20MarketSite%20(51494550508).jpg?width=640', '나스닥 마켓사이트 (CC BY 2.0)'],
  w_iphone: ['https://commons.wikimedia.org/wiki/Special:FilePath/Original%20iPhone%20docked.jpg?width=640', '초대 아이폰 (CC BY-SA 2.0)'],
  w_gfc: ['https://commons.wikimedia.org/wiki/Special:FilePath/Lehman%20Brothers%20Times%20Square%20by%20David%20Shankbone.jpg?width=640', '리먼 브라더스 본사 (CC BY-SA 3.0)'],
  w_covid: ['https://commons.wikimedia.org/wiki/Special:FilePath/Covid-19%20San%20Salvatore%2009.jpg?width=640', '팬데믹 병동 · 이탈리아 (CC BY-SA 4.0)'],
  w_genai: ['https://commons.wikimedia.org/wiki/Special:FilePath/AI%20generated%20Art%20with%20Midjourney.png?width=640', '미드저니 생성 이미지 (CC BY-SA 4.0)'],
  w_regul: ['https://commons.wikimedia.org/wiki/Special:FilePath/Hemicycle%20of%20Louise%20Weiss%20building%20of%20the%20European%20Parliament%2C%20Strasbourg.jpg?width=640', '유럽의회 본회의장 (CC BY 2.0)'],
  a_turing: ['https://commons.wikimedia.org/wiki/Special:FilePath/Alan%20Turing%20(1912-1954)%20in%201936%20at%20Princeton%20University.jpg?width=640', '앨런 튜링 · 1936 프린스턴 (Public domain)'],
  a_dartmouth: ['https://commons.wikimedia.org/wiki/Special:FilePath/Dartmouth%20Hall%20at%20Dartmouth%20College.jpg?width=640', '다트머스 홀 (CC BY 4.0)'],
  a_perceptron: ['https://commons.wikimedia.org/wiki/Special:FilePath/Mark%20I%20Perceptron%2C%20Figure%202%20of%20operator\'s%20manual.png?width=640', 'Mark I 퍼셉트론 매뉴얼 (Public domain)'],
  a_winter: ['https://commons.wikimedia.org/wiki/Special:FilePath/Marvin%20Minsky%20at%20OLPC.jpg?width=640', '마빈 민스키 (CC BY 3.0)'],
  a_backprop: ['https://commons.wikimedia.org/wiki/Special:FilePath/Geoffrey%20Hinton%20at%20Collision%202024%20in%20Toronto%20(cropped).jpg?width=640', '제프리 힌튼 (CC BY 2.0)'],
  a_deepblue: ['https://commons.wikimedia.org/wiki/Special:FilePath/Deep%20Blue.jpg?width=640', 'IBM 딥블루 (CC BY 2.0)'],
  a_dl2006: ['https://commons.wikimedia.org/wiki/Special:FilePath/Deep%20neural%20networks%20diagram.png?width=640', '심층 신경망 구조도 (CC BY 4.0)'],
  a_alexnet: ['https://commons.wikimedia.org/wiki/Special:FilePath/Nvidia%20Geforce%206600GT%20GPU%202009-01-27.jpg?width=640', '엔비디아 GPU (CC BY-SA 3.0)'],
  a_alphago: ['https://commons.wikimedia.org/wiki/Special:FilePath/Lee%20Sedol%20(B)%20vs%20AlphaGo%20(W)%20-%20Game%204.jpg?width=640', '이세돌 vs 알파고 4국 (CC BY-SA 4.0)'],
  a_transformer: ['https://commons.wikimedia.org/wiki/Special:FilePath/Googleplex-SignIn.jpg?width=640', '구글 본사 (Public domain)'],
  a_gpt3: ['https://commons.wikimedia.org/wiki/Special:FilePath/Pioneer%20Building%2C%20San%20Francisco%20(2019)%20-1.jpg?width=640', '오픈AI가 입주한 파이오니어 빌딩 (CC BY-SA 4.0)'],
  a_chatgpt: ['https://commons.wikimedia.org/wiki/Special:FilePath/ChatGPT%20essay%20draft.png?width=640', '챗GPT 화면 (Public domain)'],
  a_agent: ['https://commons.wikimedia.org/wiki/Special:FilePath/CIMON%2C%20an%20AI-powered%20robotic%20techology%20assistant%2C%20is%20pictured%20after%20being%20activated%20(iss073e0384104).jpg?width=640', 'AI 로봇 조수 CIMON · NASA (Public domain)'],
  a_2ndb: ['https://commons.wikimedia.org/wiki/Special:FilePath/Stars%20in%20the%20Night%20Sky.jpg?width=640', '밤하늘 (CC0)'],
  w_transistor: ['https://commons.wikimedia.org/wiki/Special:FilePath/Replica-of-first-transistor.jpg?width=640', '최초 트랜지스터 복제품 (Public domain)'],
  w_arpanet: ['https://commons.wikimedia.org/wiki/Special:FilePath/BBN%20Interface%20Message%20Processor%20CHM.agr.jpg?width=640', '아파넷 IMP · 컴퓨터역사박물관 (CC BY 4.0)'],
  w_google: ['https://commons.wikimedia.org/wiki/Special:FilePath/Google%20search%20result%20for%20Magic%20Flute%20opera.png?width=640', '구글 검색 화면 (CC BY-SA 4.0)'],
  w_bigdata: ['https://commons.wikimedia.org/wiki/Special:FilePath/BalticServers%20data%20center.jpg?width=640', '데이터센터 (CC BY-SA 3.0)'],
  a_eliza: ['https://commons.wikimedia.org/wiki/Special:FilePath/ELIZA%20conversation.png?width=640', '일라이자 대화 기록 (Public domain)'],
  a_expert: ['https://commons.wikimedia.org/wiki/Special:FilePath/Symbolics%20LISP%20Machine%2C%20Google%20NY%20office%20computer%20museum.jpg?width=640', '심볼릭스 리스프 머신 (CC BY 2.0)'],
  a_lstm: ['https://commons.wikimedia.org/wiki/Special:FilePath/J%C3%BCrgen%20Schmidhuber%2C%202017%20(cropped).jpg?width=640', '위르겐 슈미트후버 (CC BY 2.0)'],
  a_imagenet: ['https://commons.wikimedia.org/wiki/Special:FilePath/Fei-Fei%20Li%20at%20AI%20for%20Good%202017.jpg?width=640', '페이페이 리 (CC BY 2.0)'],
  a_gan: ['https://commons.wikimedia.org/wiki/Special:FilePath/Timeline-of-AI-generated-faces.png?width=640', 'GAN 생성 얼굴의 발전 (CC BY 4.0)'],
  a_gpt4: ['https://commons.wikimedia.org/wiki/Special:FilePath/Gpt-4-visual.png?width=640', 'GPT-4 멀티모달 (CC BY-SA 4.0)'],
  a_claude: ['https://commons.wikimedia.org/wiki/Special:FilePath/Anthropic.png?width=640', '앤트로픽 (Public domain)'],
  a_gemini: ['https://commons.wikimedia.org/wiki/Special:FilePath/Google-Deep%20Mind%20headquarters%20in%20London%2C%206%20Pancras%20Square.jpg?width=640', '구글 딥마인드 런던 본사 (CC BY-SA 4.0)'],
  a_harness: ['https://commons.wikimedia.org/wiki/Special:FilePath/Laptop%20on%20a%20neat%20desk%20(Unsplash).jpg?width=640', '작업 환경 (CC0)'],
  a_robot: ['https://commons.wikimedia.org/wiki/Special:FilePath/ASIMO%204.28.11.jpg?width=640', '휴머노이드 로봇 아시모 (CC BY-SA 3.0)'],
  a_local: ['https://commons.wikimedia.org/wiki/Special:FilePath/Computer%20mouse%20laptop%20and%20phone%20on%20a%20desk.jpg?width=640', '개인 기기 (CC BY-SA 2.0)'],
  w_nvidia: ['https://commons.wikimedia.org/wiki/Special:FilePath/NVIDIA%20Headquarters.jpg?width=640', '엔비디아 본사 (CC BY-SA 4.0)'],
  w_aimna: ['https://commons.wikimedia.org/wiki/Special:FilePath/Market%20centre%20in%20Tokyo%20stock%20exchange.jpg?width=640', '증권거래소 (CC BY 2.0)'],
  w_robotnews: ['https://commons.wikimedia.org/wiki/Special:FilePath/Autonomous%20Delivery%20Vehicle%20Pileup.jpg?width=640', '자율주행 배송 로봇 (CC BY-SA 4.0)']
};
/* 도판 뷰어 — 도판을 누르면 원본 해상도로 크게. 프레임 안 오버레이. */
function MzPhotoViewer({ ev, onClose }) {
  const P = MZ_PHOTO[ev.id];
  if (!P) return null;
  return (
    <div onClick={onClose} className="ds-scrim" role="dialog" aria-modal="true"
    style={{ position: 'absolute', inset: 0, zIndex: 90, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 16 }}>
      <div onClick={(e) => e.stopPropagation()} className="ds-window" style={{ margin: 'var(--u)', background: 'var(--ds-space)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '4px 6px 4px 12px' }}>
          <span style={{ flex: 1, minWidth: 0, fontSize: 12, fontWeight: 700, color: 'var(--c07)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{ev.title}</span>
          <MdIconButton name="close" title="닫기" onClick={onClose} />
        </div>
        <img src={P[0]} alt={ev.title}
        style={{ display: 'block', width: '100%', maxHeight: 420, objectFit: 'contain', background: 'var(--c01)' }} />
        <div style={{ padding: '10px 12px 12px', fontSize: 10, fontFamily: 'var(--font-micro)', color: 'var(--c05)', wordBreak: 'keep-all' }}>{P[1]} · 위키미디어 공용</div>
      </div>
    </div>);
}

/* 도판 — 1/4 크기로 그린 뒤 4배 확대(nearest-neighbour). 그리드 결을 사진에도 맞춘다. */
function MzPhoto({ ev }) {
  const P = MZ_PHOTO[ev.id];
  const [on, setOn] = React.useState(false);
  if (!P) return null;
  return (
    <img src={P[0]} alt="" aria-hidden="true" onLoad={() => setOn(true)}
    style={{ position: 'absolute', left: 0, top: 0, width: '25%', height: '25%', objectFit: 'cover',
      transform: 'scale(4)', transformOrigin: 'top left', imageRendering: 'pixelated',
      visibility: on ? 'visible' : 'hidden', zIndex: 1 }} />);
}
window.MZ_PHOTO = MZ_PHOTO;
...
const MZ_STARS = (() => {
  const r = mzRng(20260317),cols = ['var(--c05)', 'var(--c05)', 'var(--ds-polaris)', 'var(--c08)'],out = [];
...
const MZ_CONST = [
{ c: 'var(--accent)', o: 0.55, pts: [[44, 84], [90, 126], [138, 102], [178, 150], [138, 102], [118, 196]] },
{ c: 'var(--ds-nebula)', o: 0.5, pts: [[332, 70], [374, 118], [348, 178], [298, 150], [374, 118], [406, 92]] },
{ c: 'var(--c11)', o: 0.42, pts: [[58, 742], [112, 710], [152, 760], [214, 726], [152, 760], [178, 816]] }];
  ...
  return (
    <React.Fragment>
      <span style={{ position: 'absolute', inset: 0, borderRadius: radius,
        background: `color-mix(in srgb, ${L.accent} 16%, var(--ds-space))` }} />
...
function MzSheet({ ev, byId, onClose, onJump, go, order }) {
  ...
  const zoomStart = useMsR(null);
  const [zoom, setZoom] = useMsS(false);
  ...
  return (
    <div onClick={onClose} style={{ position: 'absolute', inset: 0, zIndex: 70, background: 'rgba(4,7,14,.6)', display: 'flex', alignItems: 'flex-end' }}>
      ...
      <div key={ev.id} onClick={(e) => e.stopPropagation()} onPointerDown={swPD} onPointerMove={swPM} onPointerUp={swPU} onPointerCancel={swPU}
        ...
        background: 'var(--ds-space)', borderTopLeftRadius: 24, borderTopRightRadius: 24, border: `1px solid ${L.accent}44`, borderBottom: 'none',
        boxShadow: 'none', transform: `translateX(${dx}px)`,
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 10px 0' }}>
          ...
          style={{ position: 'relative', width: 34, height: 34, borderRadius: 0, border: 'none', display: 'grid', placeItems: 'center', cursor: idx <= 0 ? 'default' : 'pointer', background: 'var(--panel-2)', color: idx <= 0 ? 'rgba(255,255,255,.2)' : L.accent }}>
            <span className="md-state" /><Icon name="chevron_left" size={20} />
          </button>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
            <div style={{ width: 36, height: 4, borderRadius: 0, background: 'rgba(255,255,255,.2)' }} />
          ...
          style={{ position: 'relative', width: 34, height: 34, borderRadius: 0, border: 'none', display: 'grid', placeItems: 'center', cursor: idx >= total - 1 ? 'default' : 'pointer', background: 'var(--panel-2)', color: idx >= total - 1 ? 'rgba(255,255,255,.2)' : L.accent }}>
            <span className="md-state" /><Icon name="chevron_right" size={20} />
          </button>
        </div>
        <div style={{ padding: '10px 20px 24px' }}>
          {/* lane + year */}
          <div style={{ position: 'relative', height: 150, borderRadius: 0, overflow: 'hidden', marginBottom: 14, border: `1px solid ${L.accent}33` }}>
            <MzPlate ev={ev} L={L} radius={16} glyph={150} glyphOpacity={0.26} />
            <MzPhoto ev={ev} />
            {MZ_PHOTO[ev.id] &&
            <button onPointerDown={(e) => { zoomStart.current = { x: e.clientX, y: e.clientY }; }}
            onClick={(e) => {
              e.stopPropagation();
              const s = zoomStart.current;
              if (s && (Math.abs(e.clientX - s.x) > 8 || Math.abs(e.clientY - s.y) > 8)) return; // 스와이프였으면 무시
              setZoom(true);
            }} aria-label="도판 크게 보기"
            style={{ position: 'absolute', inset: 0, zIndex: 4, border: 'none', background: 'transparent', cursor: 'zoom-in', padding: 0 }}></button>}
            ...
            <div style={{ position: 'absolute', left: 16, top: 14, zIndex: 3, display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 0, background: 'rgba(7,10,19,.5)', border: `1px solid ${L.accent}66` }}>
                <Icon name={L.icon} size={13} style={{ color: L.accent }} />
                <span style={{ fontSize: 12, fontWeight: 700, color: L.ink, whiteSpace: 'nowrap' }}>{L.label}</span>
              </span>
              {ev.here && <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 8px', borderRadius: 0, background: L.accent, color: 'var(--ds-space-2)' }}>지금 여기</span>}
            </div>
            <div style={{ position: 'absolute', left: 16, right: 16, bottom: 12, zIndex: 3, pointerEvents: 'none' }}>
              ...
              <div style={{ fontSize: 24, fontWeight: 700, color: 'var(--c08)', letterSpacing: '-.01em', lineHeight: 1.15 }}>{ev.title}</div>
              <div className="md-body-small" style={{ color: L.ink, marginTop: 2 }}>{ev.sub}</div>
            </div>
          </div>
          {MZ_PHOTO[ev.id] &&
          <div style={{ fontSize: 10, fontFamily: 'var(--font-micro)', color: 'rgba(199,213,240,.5)', margin: '0 0 12px', wordBreak: 'keep-all' }}>{MZ_PHOTO[ev.id][1]} · 위키미디어 공용</div>}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 16 }}>
            {D.facts.map((f, i) =>
            <div key={i} style={{ padding: '9px 12px', borderRadius: 0, background: L.tint, border: `1px solid ${L.accent}22` }}>
              <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, letterSpacing: '.1em', color: L.accent, marginBottom: 3 }}>{f[0]}</div>
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--c07)', wordBreak: 'keep-all', lineHeight: 1.3 }}>{f[1]}</div>
            </div>
            )}
          </div>}
          ...
          {/* cause → effect */}
          {(D.cause || D.effect) &&
          <div style={{ marginTop: 18, borderRadius: 0, overflow: 'hidden', border: `1px solid ${L.accent}26`, background: 'rgba(255,255,255,.02)' }}>
            {D.cause &&
            <div style={{ display: 'flex', gap: 11, padding: '11px 13px' }}>
              <Icon name="south" size={15} style={{ color: L.accent, flex: '0 0 auto', marginTop: 1 }} />
              <div>
                <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, letterSpacing: '.12em', color: L.accent, marginBottom: 3 }}>배경</div>
                <div style={{ fontSize: 12, color: 'rgba(214,226,248,.82)', lineHeight: 1.5, wordBreak: 'keep-all' }}>{D.cause}</div>
              </div>
            </div>}
            ...
            <div style={{ display: 'flex', gap: 11, padding: '11px 13px' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, letterSpacing: '.12em', color: L.accent, marginBottom: 3 }}>영향</div>
                <div style={{ fontSize: 12, color: 'rgba(214,226,248,.82)', lineHeight: 1.5, wordBreak: 'keep-all' }}>{D.effect}</div>
              </div>
            </div>}
          </div>}
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 7, marginTop: 16 }}>
            {ev.tags.map((tg) =>
            <span key={tg} style={{ fontSize: 12, fontWeight: 700, color: L.ink, padding: '5px 11px', borderRadius: 0, background: L.tint, border: `1px solid ${L.accent}33` }}>{tg}</span>
            )}
          </div>}
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {ev.rel.filter((id) => byId[id]).map((id) => {const r = byId[id],RL = MZ_LANES[r.lane];return (
                  ...
                  style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 11, padding: '10px 12px', borderRadius: 0, cursor: 'pointer', textAlign: 'left',
                    background: 'var(--panel-2)', border: '1px solid var(--panel-2)' }}>
                  <span className="md-state" />
                  <span style={{ width: 9, height: 9, borderRadius: 0, background: RL.accent, flex: '0 0 auto', boxShadow: 'none' }} />
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--c07)' }}>{r.title}</div>
                    <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 12, color: RL.accent }}>{RL.label} · {r.ylabel}</div>
                  </div>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {ev.refs.map((rf, i) =>
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '10px 12px', borderRadius: 0, background: 'var(--panel-2)', border: '1px solid var(--panel-2)' }}>
                <div style={{ width: 32, height: 32, borderRadius: 0, flex: '0 0 auto', display: 'grid', placeItems: 'center', background: L.tint }}>
                  <Icon name={refIcon[rf.kind] || 'link'} size={17} style={{ color: L.accent }} />
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 15, fontWeight: 400, color: 'var(--c07)', wordBreak: 'keep-all' }}>{rf.label}</div>
          ...
          {ev.here &&
          <MdButton variant="filled" full trailingIcon="north_east" onClick={() => go('home')} style={{ marginTop: 22, background: L.accent, color: 'var(--ds-space-2)' }}>별자리로 돌아가기</MdButton>}
        </div>
      </div>
      {zoom && <MzPhotoViewer ev={ev} onClose={() => setZoom(false)} />}
    </div>);

}

/* ===================== MUSEUM 타임라인 ===================== */
function MuseumScreen({ t, go, param }) {
  const C = window.SB.C;
  ...
  /* 대화창의 '보러가기' — 스크롤은 마운트 효과가 맡고, 여기선 시트만 연다.
     sel 은 이벤트 객체를 담는다 — id 문자열을 넣으면 MzSheet 가 ev.lane 에서 터진다. */
  const focused = useMsR(null);
  useMsE(() => {
    const fid = param && param.focusId;
    if (!fid || focused.current === fid || !byId[fid]) return;
    focused.current = fid;
    setSel(byId[fid]);
  }, [param && param.focusId]);
  ...
  useMsE(() => {
    ...
    if (el) {
      /* focusId 로 들어왔으면 그 전시로, 아니면 기본 NOW(2022) 위치로.
         마운트 스크롤은 이 한 곳에서만 정한다 — 별도 효과를 두면 나중 것이 덮어쓴다. */
      const fid = param && param.focusId;
      const fx = fid && pos[fid] ? pos[fid].x : null;
      const target = Math.max(0, (fx != null ? fx : mzX(2022)) - el.clientWidth / 2);
  ...
  const Node = (ev) => {
    ...
    return (
      ...
      style={{ position: 'absolute', left: p.x - MZ.NODE_W / 2, top: p.top, width: MZ.NODE_W, height: MZ.NODE_H,
        padding: 0, overflow: 'hidden', textAlign: 'left', cursor: 'pointer', borderRadius: 0, background: 'var(--ds-space)',
        ...
        <span style={{ position: 'absolute', inset: 0, background: 'transparent', boxShadow: 'inset 0 -34px 0 0 color-mix(in srgb, var(--ds-space) 78%, transparent)' }} />
        <span className="md-state" />
        ...
        {ev.here && <span style={{ position: 'absolute', top: 8, right: 9, fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, fontWeight: 700, color: L.accent, letterSpacing: '.1em' }}>NOW</span>}
        <span style={{ position: 'absolute', left: 10, right: 9, bottom: 8, fontSize: 12, fontWeight: 700, color: 'var(--c08)', lineHeight: 1.16, wordBreak: 'keep-all', textShadow: '0 1px 6px rgba(0,0,0,.85)' }}>{ev.title}</span>
      </button>);
  ...
  return (
    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden', boxSizing: 'border-box', paddingTop: 92,
      background: 'radial-gradient(120% 60% at 50% 4%, rgba(40,86,150,.42), transparent 58%), radial-gradient(86% 56% at 86% 16%, rgba(120,96,210,.22), transparent 58%), var(--ds-space)' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 8, padding: '6px 16px 8px' }}>
        <span style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 12, fontWeight: 700, color: 'rgba(159,184,222,.7)', letterSpacing: '.04em' }}>1936 — 2026</span>
        <span style={{ flex: 1 }} />
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, color: 'rgba(159,184,222,.7)', whiteSpace: 'nowrap' }}>
      ...
      <div ref={scroller} className="mz-hscroll" onScroll={onScroll} onWheel={onWheel} onPointerDown={onDown} onPointerMove={onMove} onPointerUp={onUp} onPointerLeave={onUp}
        ...
        <div style={{ position: 'relative', width: MZ.W, height: MZ.TH, flex: '0 0 auto' }}>
          ...
          <svg width={MZ.W} height={MZ.TH} style={{ position: 'absolute', left: 0, top: 0, overflow: 'visible' }}>
            ...
            {/* now marker */}
            <line x1={mzX(2026)} y1={20} x2={mzX(2026)} y2={MZ.TH - 8} stroke="var(--ds-nebula)" strokeOpacity=".5" strokeWidth="1.5" strokeDasharray="3 4" />
            {/* connectors */}
            {links.map((lk) => {
        ...
        <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 42, pointerEvents: 'none', zIndex: 9, display: 'flex', alignItems: 'center',
          ...
          <div style={{ position: 'relative', height: MZ.TH, width: '100%' }}>
            ...
            <div key={L.id} style={{ position: 'absolute', left: 7, top: bandCenter[L.id], transform: 'translateY(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
              <span style={{ width: 9, height: 9, borderRadius: 0, background: L.accent, boxShadow: 'none' }} />
              <span style={{ writingMode: 'vertical-rl', textOrientation: 'mixed', fontSize: 12, fontWeight: 700, letterSpacing: '.02em', color: L.ink, textShadow: '0 1px 6px rgba(0,0,0,.9)', whiteSpace: 'nowrap' }}>{L.label}</span>
            </div>
            )}
          </div>
        </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 12, padding: '6px 16px 14px' }}>
        <div style={{ width: 52, flex: '0 0 auto', textAlign: 'center' }}>
          <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 24, fontWeight: 700, lineHeight: 1, color: 'var(--ds-star)', letterSpacing: '-.01em' }}>{Math.round(curYear)}</div>
          <div style={{ fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, fontWeight: 700, letterSpacing: '.22em', color: 'rgba(159,184,222,.55)', marginTop: 3 }}>YEAR</div>
        </div>
        <div onPointerDown={onDialDown} onPointerMove={onDialMove} onPointerUp={onDialUp} onPointerCancel={onDialUp}
        style={{ position: 'relative', flex: 1, height: 44, borderRadius: 0, cursor: 'pointer', touchAction: 'none', background: 'rgba(11,17,32,.6)', border: '1px solid rgba(127,178,255,.16)', overflow: 'hidden' }}>
          ...
          {decades.map((d) => {const f = (d - MZ.START) / (MZ.END - MZ.START);return (
              ...
              <div style={{ position: 'absolute', left: `${f * 100}%`, bottom: 3, transform: 'translateX(-50%)', fontFamily: 'var(--md-ref-typeface-mono)', fontSize: 10, color: 'rgba(159,184,222,.5)' }}>{'’' + String(d).slice(2)}</div>
            </React.Fragment>);
          })}
          <div style={{ position: 'absolute', left: `${yearFrac * 100}%`, top: 5, bottom: 5, transform: 'translateX(-50%)', pointerEvents: 'none' }}>
            <div style={{ width: 2.5, height: '100%', borderRadius: 0, background: 'linear-gradient(var(--c11),var(--accent))', boxShadow: 'none' }} />
            <div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%,-50%)', width: 13, height: 13, borderRadius: 0, background: 'var(--ds-star)', border: '2px solid var(--accent)', boxShadow: 'none' }} />
          </div>
        </div>
      </div>
